                ...
                <div class="container px-4 mx-auto">
                    <div class="flex flex-wrap -mx-4 mb-8">
                        <div class="w-full lg:w-1/3 px-4 mb-8 lg:mb-0">
                            <div class="mt-8">
                                <h3 class="text-2xl font-bold tracking-wide text-white mb-1">Mint NFT</h3>
                                <p class="text-xs text-gray-300">Lorem ipsum dolor sit amet</p>
                            </div>
                        </div>
                        <div class="w-full lg:w-2/3 px-4">
                            <div class="px-8 md:px-16 pt-16 pb-8 bg-gray-800 rounded-xl">
                                        ...
                                        <div class="flex flex-wrap -mx-4 -mb-10">
                                            <div class="w-full md:w-1/2 px-4 mb-10">
                                                <div
                                                    ...
                                                    <span
                                                        class="absolute bottom-full left-0 ml-3 -mb-1 transform translate-y-0.5 text-xs font-semibold text-gray-300 px-1 bg-gray-500">NFT
                                                        Name</span>
                                                    <input
                                                        class="block w-full outline-none bg-transparent text-gray-50 placeholder-gray-50 font-semibold"
                                                        id="formInput2-1" type="text" placeholder="nft name">
                                                </div>
                                            </div>
                                            <div class="w-full md:w-1/2 px-4 mb-10">
                                                <div
                                                    class="relative w-full h-14 py-4 px-3 border border-gray-400 hover:border-white focus-within:border-green-500 rounded-lg">
                                                    <span
                                                        class="absolute bottom-full left-0 ml-3 -mb-1 transform translate-y-0.5 text-xs font-semibold text-gray-300 px-1 bg-gray-500">Amount to be created
                                                        </span>
                                                    <input
                                                        class="block w-full outline-none bg-transparent text-gray-50 placeholder-gray-50 font-semibold"
                                                        id="formInput2-2" type="text" placeholder="amount">
                                                </div>
                                            </div>
                                            <div class="w-full md:w-1/2 px-4 mb-10">
                                                <div
                                                    class="relative w-full h-14 py-4 px-3 border border-gray-400 hover:border-white focus-within:border-green-500 rounded-lg">
                                                    <span
                                                        class="absolute bottom-full left-0 ml-3 -mb-1 transform translate-y-0.5 text-xs font-semibold text-gray-300 px-1 bg-gray-500">Royalty</span>
                                                    <input
                                                        class="block w-full outline-none bg-transparent text-gray-50 placeholder-gray-50 font-semibold"
                                                        id="formInput2-3" type="number" placeholder="johndoe@trizzle.ui">
                                                </div>
                                            </div>
                                            <div class="w-full md:w-1/2 px-4 mb-10">
                                                <div
                                                    class="relative w-full h-14 py-4 px-3 border border-gray-400 hover:border-white focus-within:border-green-500 rounded-lg">
                                                    <span
                                                        class="absolute bottom-full left-0 ml-3 -mb-1 transform translate-y-0.5 text-xs font-semibold text-gray-300 px-1 bg-gray-500">Price in LTC</span>
                                                    <input
                                                        class="block w-full outline-none bg-transparent text-gray-50 placeholder-gray-50 font-semibold"
                                                        id="formInput2-4" type="number" placeholder="0.00">
                                                </div>
                                            </div>
                                            <div class="w-full px-4 mb-10">
                                                <div
                                                    ...
                                                    <span
                                                        class="absolute bottom-full left-0 ml-3 -mb-1 transform translate-y-0.5 text-xs font-semibold text-gray-300 px-1 bg-gray-500">Description
                                                        </span>
                                                    <textarea
                                                        class="block w-full h-64 outline-none bg-transparent text-gray-50 placeholder-gray-50 font-semibold resize-none"
                                                        id="formInput2-5" name="" cols="30" rows="10"
                                            ...
                                            <div class="w-full px-4 mb-10">
                                                <div class="flex flex-wrap sm:flex-nowrap">
                                                    <div class="flex-shrink-0 w-20 h-20 mb-4 mr-4 rounded-full">
                                                        <img src="~/assets/trizzle-assets/images/avatar-photo-form.png" alt="">
                                                    </div>
                                                    <div
                                                        ...
                                                        <div class="relative group h-14 w-14 mx-auto mb-4">
                                                            ...
                                                            <input class="absolute top-0 left-0 h-14 w-14 opacity-0"
                                                                id="formInput2-6" type="file" name="filephoto">
                                                        </div>
                                                        ...
                                                        <span class="text-xs text-gray-300 font-semibold">PNG, JPG, GIF
                                                            or up to 10MB</span>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="flex flex-wrap -mx-4">
                        <div class="w-full lg:w-1/3 px-4 mb-8 lg:mb-0">
                            <div class="mt-8">
                                <h3 class="text-2xl font-bold tracking-wide text-white mb-1">Address</h3>
                                <p class="text-xs text-gray-300">Lorem ipsum dolor sit amet</p>
                            </div>
                        </div>
                        <div class="w-full lg:w-2/3 px-4">
                                        ...
                                        <div class="flex flex-wrap -mx-4 -mb-10">
                                            <div class="w-full md:w-1/2 px-4 mb-10">
                                                <div
                                                    class="relative w-full h-14 py-4 px-3 border border-gray-400 hover:border-white focus-within:border-green-500 rounded-lg">
                                                    <span
                                                        class="absolute bottom-full left-0 ml-3 -mb-1 transform translate-y-0.5 text-xs font-semibold text-gray-300 px-1 bg-gray-500">Country</span>
                                                    <input
                                                        class="block w-full outline-none bg-transparent text-gray-50 placeholder-gray-50 font-semibold"
                                                        id="formInput2-7" type="text" placeholder="United States">
                                                </div>
                                            </div>
                                            <div class="w-full md:w-1/2 px-4 mb-10">
                                                <div
                                                    class="relative w-full h-14 py-4 px-3 border border-gray-400 hover:border-white focus-within:border-green-500 rounded-lg">
                                                    <span
                                                        class="absolute bottom-full left-0 ml-3 -mb-1 transform translate-y-0.5 text-xs font-semibold text-gray-300 px-1 bg-gray-500">City</span>
                                                    <input
                                                        class="block w-full outline-none bg-transparent text-gray-50 placeholder-gray-50 font-semibold"
                                                        id="formInput2-8" type="text" placeholder="New York">
                                                </div>
                                            </div>
                                            <div class="w-full md:w-1/2 px-4 mb-10">
                                                <div
                                                    class="relative block px-3 w-full font-medium border border-gray-400 hover:border-white focus-within:border-green-500 rounded-lg">
                                                    <span
                                                        class="absolute bottom-full left-0 ml-3 -mb-1 transform translate-y-0.5 text-xs font-semibold text-gray-300 px-1 bg-gray-500">State/Province</span>
                                                    <span
                                                    ...
                                                    <select
                                                        class="w-full py-4 text-gray-50 font-semibold appearance-none bg-transparent outline-none"
                                                        id="formInput2-9" name="">
                                                        <option class="bg-gray-500" value="1">New York</option>
                                                        <option class="bg-gray-500" value="1">New York</option>
                                                        <option class="bg-gray-500" value="1">New York</option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="w-full md:w-1/2 px-4 mb-10">
                                                <div
                                                    class="relative w-full h-14 py-4 px-3 border border-gray-400 hover:border-white focus-within:border-green-500 rounded-lg">
                                                    <span
                                                        class="absolute bottom-full left-0 ml-3 -mb-1 transform translate-y-0.5 text-xs font-semibold text-gray-300 px-1 bg-gray-500">Zip/Postal
                                                        Code</span>
                                                    <input
                                                        class="block w-full outline-none bg-transparent text-gray-50 placeholder-gray-50 font-semibold"
                                                        id="formInput2-10" type="text" placeholder="550-750">
                                                </div>
                                            </div>
                                            <div class="w-full px-4 mb-10">
                                                <div
                                                    class="relative w-full h-14 py-4 px-3 border border-gray-400 hover:border-white focus-within:border-green-500 rounded-lg">
                                                    <span
                                                        class="absolute bottom-full left-0 ml-3 -mb-1 transform translate-y-0.5 text-xs font-semibold text-gray-300 px-1 bg-gray-500">Street
                                                        address</span>
                                                    <input
                                                        class="block w-full outline-none bg-transparent text-gray-50 placeholder-gray-50 font-semibold"
                                                        id="formInput2-11" type="text">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mt-8 text-right">
...
<script>
import Dashboardheader from '~~/components/DasboardComponent/Dashboardheader.vue'
export default {
