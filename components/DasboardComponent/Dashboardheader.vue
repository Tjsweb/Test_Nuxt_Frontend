<template>
    <section>
        <nav class="relative flex items-center justify-between py-5 px-8 bg-gray-900 mb-3">
          <div class="w-full xl:w-auto px-2">
            <div class="flex items-center justify-between">
              <a class="inline-flex items-center h-8" href="#">
                <img src="~/assets/trizzle-assets/logos/trizzle-logo.svg" alt=""></a>
              <div class="xl:hidden">
              ...
              <div
                class="hidden xl:inline-flex h-14 p-3 items-center w-40 2xl:w-56 bg-gray-700 border border-gray-400 rounded-lg">
                <a class="inline-block text-gray-400 hover:text-gray-300" href="#">
                ...
                <input class="pl-3 bg-transparent text-gray-100 placeholder-gray-400 outline-none"
                  id="horizontalNavInput5-1" type="text" placeholder="Search...">
              </div>
            </div>
          </div>
          <div
            class="hidden xl:block w-full md:w-auto px-2 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <ul class="flex items-center">
              <li class="mr-10"><a class="inline-block text-sm font-semibold text-gray-300 hover:text-gray-200"
                  href="#">Overview</a></li>
              <li class="mr-10"><a class="inline-block text-sm font-semibold text-gray-300 hover:text-gray-200"
                  href="#">Analytics</a></li>
              <li class="mr-10"><a class="inline-block text-sm font-semibold text-gray-300 hover:text-gray-200"
              ...
              <li class="mr-10">
                <a class="inline-flex items-center text-sm font-semibold text-gray-300 hover:text-gray-200" href="#">
                  <span>Orders</span>
                  <div
                    class="flex w-5 h-5 ml-2 items-center justify-center text-xs text-white bg-blue-500 rounded-full">4
                  </div>
                </a>
              </li>
              <li><a class="inline-block text-sm font-semibold text-gray-300 hover:text-gray-200" href="#">Customers</a>
              </li>
            </ul>
          </div>
          <div class="hidden xl:block w-full md:w-auto px-2">
            <div class="flex flex-wrap items-center -mb-2">
              ...
              <a class="group inline-flex mb-2 items-center" href="#">
                <img class="h-8 w-8 mr-3 rounded-full object-cover" src="~/assets/trizzle-assets/images/avatar-men.png"
                  alt="">
          ...
          <nav class="relative flex flex-col p-8 h-full w-full bg-gray-700 overflow-y-auto">
            <div class="flex items-center justify-between mb-8">
              <a class="inline-flex items-center" href="#">
                <img class="h-10" src="~/assets/trizzle-assets/logos/trizzle-logo.svg" alt=""></a>
              <button class="navbar-close">
                <svg class="h-6 w-6 text-gray-400 cursor-pointer" xmlns="http://www.w3.org/2000/svg" fill="none"
                  viewbox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                </svg></button>
            </div>
            <div class="flex w-full h-14 p-3 mb-24 items-center bg-gray-700 border border-gray-400 rounded-lg">
              <a class="inline-block text-gray-400 hover:text-gray-300" href="#">
              ...
              <input class="pl-3 text-sm bg-transparent text-gray-100 placeholder-gray-400 outline-none"
                id="horizontalNavInput5-1" type="text" placeholder="Search...">
            </div>
            <ul class="mb-10">
              <li class="mb-10"><a class="inline-block text-lg font-semibold text-gray-300 hover:text-gray-200"
                  href="#">Overview</a></li>
              <li class="mb-10"><a class="inline-block text-lg font-semibold text-gray-300 hover:text-gray-200"
                  href="#">Analytics</a></li>
              <li class="mb-10"><a class="inline-block text-lg font-semibold text-gray-300 hover:text-gray-200"
                  href="#">Products</a></li>
              <li class="mb-10">
                <a class="inline-flex w-full items-center justify-between text-lg font-semibold text-gray-300 hover:text-gray-200"
                  href="#">
                  <span>Orders</span>
                  <div
                    class="flex w-5 h-5 ml-2 items-center justify-center text-xs text-white bg-blue-500 rounded-full">4
              ...
              <li><a class="inline-block text-lg font-semibold text-gray-300 hover:text-gray-200" href="#">Customers</a>
              </li>
            </ul><a class="flex mt-auto items-center justify-between" href="#">
              <div class="flex items-center">
                <img class="h-8 w-8 mr-3 rounded-full" src="~/assets/trizzle-assets/images/avatar-men-2.png" alt="">
                <h5 class="leading-none font-semibold text-gray-100">John Doe</h5>
              </div>
              <svg width="10" height="6" viewbox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1 1L5 5L9 1" stroke="#3D485B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                </path>
              </svg>
            </a>
          </nav>
