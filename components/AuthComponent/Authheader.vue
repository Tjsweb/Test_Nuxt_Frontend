<template>
  <section>
  <nav class="relative flex items-center justify-between py-5 px-8 bg-gray-700 mb-3">
    ...
    <div class="hidden xl:block w-full md:w-auto px-2">
      <div class="flex flex-wrap items-center -mb-2">
        ...
        <a class="group inline-flex mb-2 items-center" href="#">
          <img class="h-8 w-8 mr-3 rounded-full object-cover" src="~/assets/trizzle-assets/images/avatar-men.png" alt="">
    ...
    <nav class="relative flex flex-col p-8 h-full w-full bg-gray-700 overflow-y-auto">
      <div class="flex items-center justify-between mb-8">
        <a class="inline-flex items-center" href="#">
          <img class="h-10" src="~/assets/trizzle-assets/logos/trizzle-logo.svg" alt="">
        </a>
